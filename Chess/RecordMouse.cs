...
{
    // Merci StackOverflow.
    // J'ai fait quelques modifications pour le reliser avec ma classe Chess.cs
    class RecordMouse
    {

        public static bool isNotDrawing = true;
        public static bool runProcess = false;
        public static int isMouseHeld = 0x0;
